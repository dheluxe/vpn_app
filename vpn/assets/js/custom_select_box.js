jQuery(document).ready(function(){
    $("body").on("mousedown",".active_option .display_value",function(){
        if(event.which == 1){
            ...
            if($("."+select_box_class+" .processing_inactive_option").hasClass("hidden")){
                $("."+select_box_class+" .processing_inactive_option").removeClass("hidden");
            }else{
                $("."+select_box_class+" .processing_inactive_option").addClass("hidden");
            }
        }
    });
        ...
        if(event.which == 1){
            ...
            if(value!=$("."+select_box_class+" .active_option .display_value").attr("data-value")){
                if(value==""){
                    ...
                    $("."+select_box_class+" .active_option").trigger("change",value);
                }
    ...
    $("body").on("click",".custom_select_box", function(){
        ...
        jQuery(".custom_select_box").each(function(){
            ...
            if(select_box_class!=box_class){
                ...
                $("."+box_class+" .processing_inactive_option").addClass("hidden");
            }
        });
    });
